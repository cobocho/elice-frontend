...
export type ApiEventsEventIdDeleteMutationError =
...
export const apiEventsEventIdGrouppingPost = (
	...
	return customInstance<ApiEventsEventIdGrouppingPost200>(
		{
			url: `/api/events/${eventId}/groupping`,
			method: 'POST',
			headers: { 'Content-Type': 'application/json' },
...
export const getApiEventsEventIdGrouppingPostMutationOptions = <
	TError = ErrorType<HTTPValidationError>,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
...
export type ApiEventsEventIdGrouppingPostMutationResult = NonNullable<
	Awaited<ReturnType<typeof apiEventsEventIdGrouppingPost>>
>;
export type ApiEventsEventIdGrouppingPostMutationBody =
	BodyType<EventGroupingRequest>;
export type ApiEventsEventIdGrouppingPostMutationError =
	ErrorType<HTTPValidationError>;

/**
 * @summary 이벤트 참여자 그룹핑
 */
export const useApiEventsEventIdGrouppingPost = <
	TError = ErrorType<HTTPValidationError>,
	TContext = unknown,
>(options?: {
	mutation?: UseMutationOptions<
...
> => {
	const mutationOptions =
		getApiEventsEventIdGrouppingPostMutationOptions(options);
